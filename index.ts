...
async function AskQuestion() {
  const answers = await inquirer.prompt([
    ...
    },
    {
      ...
      name: "Question3",
      message:
        "which if the following file name is the extension for Typescript?",
    ...
    },
    {
      ...
      name: "Question4",
      message:
        "Which of the computer programming language below has influenced the creation of Typescript?",
